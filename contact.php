...
<body class="flex flex-col min-h-screen">
    ...
    <div class="flex justify-center md:pl-64 py-4">
        <section class="bg-slate-100 border rounded-lg">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 ">Contact Us</h2>
                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500  sm:text-xl">Got a issue?
                    Want to send feedback about our feature? Something not working? Let us know.
                </p>
                <form action="#" class="space-y-8">
                    <div>
                        ...
                        <input type="email" id="email"
                            ...
                            placeholder="name@tribus.com" required>
                    </div>
                    <div>
