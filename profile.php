...
<body class="flex flex-col min-h-screen">
        ...
        <div class="flex-initial">
            <div class="flex justify-end items-center relative">
                <div class="flex mr-4 items-center gap-4">
                    <a class="inline-block py-2 px-6 bg-black rounded-lg border border-black text-white" href="./logout.php">
                        <div class="flex items-center relative cursor-pointer whitespace-nowrap">
                            Logout
                        </div>
                    </a>
    ...
    <div class="md:ml-64 pl-6 pt-8">
        ...
        <div>
            ...
            <div class="bg-gray-100 p-3 flex-auto w-11/12 border rounded">
