      ...
      <form class="bg-slate-100 p-5 px-5 rounded-md border" method="post">
        ...
        <div class="grid gap-6 mb-4 md:grid-cols-2">
          <div>
            ...
            <input type="text" id="first_name" name="Firstname" value="<?php
                                                                        ...
                                                                        ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="John" required>
          </div>
          <div>
            ...
            <input type="text" id="last_name" name="Lastname" value="<?php
                                                                      ...
                                                                      ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Doe" required>
          </div>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="contact" name="contact" value="<?php
                                                                ...
                                                                ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="+977-9876543210" required>
        </div>
        <div class="mb-4">
          ...
          <input type="text" id="address" name="address" value="<?php
                                                                ...
                                                                ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Kathmadu" required>
        </div>
        <div class="mb-4">
        ...
        <div class="flex items-start mb-4">
          <div class="flex items-center h-5">
            <input id="remember" type="checkbox" value="" name="confirm" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 " required>
          </div>
        ...
        <button type="submit" name="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Register</button>
