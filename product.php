                ...
                <div class="flex flex-col p-2 justify-between">
                 ...
                 ?>
                    ...
                    <div class="text-sm font-medium my-4">
                        <a href="./User/addToCart.php?id=<?php echo $id?>&action=add"
                        ...
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 m-2">
                            <div class="px-4 py-2 bg-white rounded-t-lg ">
                                <textarea disabled id="comment" rows="4"
                                    class="w-full px-0 text-sm cursor-not-allowed text-gray-900 bg-white border-0 focus:ring-0 focus:border-transparent"
