    ...
    if(validatePhoneNumber($contact)){
        ...
        if($PhoneExists){
            ...
            if($Emailexists){
                ...
                echo "The user with same email already exists. Please verify it and provide the email used to create your account.";
            }
...
<!-- Footer -->
<footer
    class="md:ml-64 mt-auto bg-slate-100 text-center text-neutral-600  lg:text-left border-t-2">
    <div
      class="flex items-center justify-center border-b border-neutral-200 p-4  lg:justify-between ">
