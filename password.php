      ...
      <form class="bg-slate-100 p-5 px-5 rounded-md border w-96" method="post">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <div class="mb-6">
            ...
            <input type="email" name="Remail" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="example@abc.com" required>
          </div>
          <div>
            <label for="contact" class="block mb-2 text-sm font-medium text-gray-900 ">Contact</label>
            <input type="contact" name="Rcontact" id="contact" placeholder="+9779876543210" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " required="">
          </div>

          <button type="submit" name="Rsubmit" class="w-full text-white bg-blue-600 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Continue</button>
      </form>
      <?php
      if (isset($_POST['Rsubmit'])) {
        $email = trim($_POST['Remail']);
