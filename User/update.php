        ...
        <div class="flex md:pl-64 py-4">
            <form class="bg-slate-100 p-5 px-5 rounded-md border" method='post'>
                ...
                <div>
                        ...
                        echo $email;
                        ?>"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " value="<?php echo $row['FIRSTNAME']; ?>" disabled>
                    </div>
                    <div>
