...
<body>
    <div class="top-wrapper flex flex-col max-w-full">
        <!-- component -->
        <nav class="bg-slate-100 sticky top-0 w-full flex flex-wrap items-center mx-auto px-4 py-4 md:px-8 border-b bg-opacity-[0.97] z-10">
            ...
            <button class="text-black inline-flex p-3 hover:bg-gray-900 rounded lg:hidden ml-auto hover:text-white outline-none nav-toggler" data-target="#navigation">
                ...
                <!-- nav links -->
                <div id="navigation" class="hidden top-navbar w-full lg:w-auto px-6 lg:px-0 mt-4 lg:inline-flex lg:mt-0 lg:flex-grow lg:justify-between lg:flex-row">
                    <div class="lg:ml-4 mb-4 lg:mb-0 flex-initial flex w-full lg:w-auto">
                        <div class="flex justify-end items-center relative">
                            <div class="flex flex-col lg:flex-row mr-4 lg:items-center text-sm">
                                <a class="inline-block py-2 px-3 hover:bg-gray-200 rounded-lg" href="#">
                    ...
                    <!-- search bar -->
                    <div class="flex flex-shrink flex-grow-0 justify-start px-3 mb-4 lg:mb-0 items-center">
                    ...
                    <div class="flex px-3 lg:px-0 lg:justify-end items-center relative">
                        ...
                        <div class="flex justify-center">
                            <div class="relative inline-block">
                                ...
                                <button data-target="#user-dropdown" class="user-dropdown rounded-full transition-border border-2 border-slate-300 hover:border-black focus:border-black relative z-10 flex items-center text-sm text-gray-600 focus:border-blue-500 focus:ring-opacity-40 focus:ring-blue-300 focus:ring focus:outline-none">
                                    <a href="#" class="flex items-center text-sm transition-colors w-12 h-12 overflow-hidden items-center justify-center duration-200 transform shadow-lg rounded-full">
                                        <h3 class="text-xl font-medium text-slate-700">MK</h3>
                                    </a>
                                </button>

                                <!-- Dropdown menu -->
                                <div id="user-dropdown" class="hidden absolute -right-100 lg:right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl">
                                    <a href="#" class="flex items-center p-3 -mt-2 text-sm transition-colors duration-200 transform hover:bg-black  hover:text-white">
        ...
        <div class="flex max-w-full">
            <!-- Sidebar -->
            <aside class="hidden lg:flex w-full max-w-[250px] bg-slate-100 border-r">
                <menu class="w-full p-4 flex flex-col gap-2">
            ...
            <section class="main-section w-full">
                <div class="main-body 2xl:flex">
                    <div class="w-auto lg:w-full p-8">
                        <div class="mb-8">
                            <h3 class="text-2xl font-sans font-bold mb-12">Trader's Review</h3>
                            <div class="responsive-slider flex items-center">
                                <div class="flex flex-col rounded-lg overflow-hidden shadow-lg">
                                    <div class="p-4 flex flex-col gap-2 w-[300px]">
                                        <div class="font-medium">XXXXXXX</div>
                                        <div class="flex justify-between flex-col gap-2">
                                            <div class="font-bold text-2xl">18237</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col rounded-lg overflow-hidden shadow-lg">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".user-dropdown").each(function(_, userDropdown) {
                var dropdownTarget = $(userDropdown).data("target");
