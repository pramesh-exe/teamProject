...
if (isset($_GET['id']) && isset($_GET['action'])) {
    ...
    $insertSql = "INSERT INTO SHOP(NAME, OWNER_NAME, TYPE, FK1_USER_ID) VALUES(:sname, :owner_name, :type, :fk1_user_id)";
    $insertS = oci_parse($conn, $insertSql) or die(oci_error($conn, $insertSql));
    oci_bind_by_name($insertS, ":sname", $Fsname);
    oci_bind_by_name($insertS, ":owner_name", $user);
    oci_bind_by_name($insertS, ":type", $Fscategory);
