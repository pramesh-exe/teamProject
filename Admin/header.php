<!-- component -->
<nav
    class="bg-slate-100 sticky top-0 w-full flex justify-between items-center mx-auto md:px-8 px-2 h-20 border-b bg-opacity-[0.97]">
    <div class="flex items-start justify-between gap">
        ...
        <a class="flex items-start gap-2" href="./admin_dashboard.php">
