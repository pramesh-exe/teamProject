...
<body>
    <div class="top-wrapper flex flex-col max-w-full">
        <!-- component -->
        <nav
            class="bg-slate-100 sticky top-0 w-full flex flex-wrap items-center mx-auto px-4 py-4 md:px-8 border-b bg-opacity-[0.97] z-10">
            ...
            <!-- nav links -->
            <div id="navigation"
                class="hidden top-navbar w-full lg:w-auto px-6 lg:px-0 mt-4 lg:inline-flex lg:mt-0 lg:flex-grow lg:justify-between lg:flex-row">
                ...
                <!-- search bar -->
                <div class="flex flex-shrink flex-grow-0 justify-start px-3 mb-4 lg:mb-0">
        ...
        <div class="w-full">
            <div class="flex flex-col lg:flex-row max-w-full">
                <!-- Sidebar -->
                <aside class="flex w-full lg:max-w-[250px] bg-slate-100 border-r">
                    <menu
