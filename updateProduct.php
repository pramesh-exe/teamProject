            ...
            <div class="py-8 lg:py-16 px-4">
                ...
                <form method="post" class="space-y-8" enctype="multipart/form-data">
                    <div>
                        ...
                        $productName
                        ?>"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  " placeholder="Product Name" required>
                    </div>
                    <div class="sm:col-span-2">
                        ...
                        $des
                        ?>"
                        rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 " placeholder="Leave a comment..."></textarea>
                    </div>
                    <div class="grid gap-6 mb-4 md:grid-cols-2">
                        ...
                        $st
                        ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="000" required>
                        </div>
                        <div>
                        ...
                        $pr
                        ?>" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="00.00" required>
                        </div>
                    </div>
                    <div>
                    ...
                    <button type="submit" name="updateproduct" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-blue-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 ">Upload</button>
                    <?php 
                       echo $message;                      
                    ?>
                </form>
